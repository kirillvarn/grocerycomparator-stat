...
# correlate_by_one("datasets/pizza.csv", ["datasets/beef.csv"], model="gaussian")
...
# correlate_by_one("datasets/pizza.csv", ["datasets/wheat.csv"], model="gaussian")
...
# correlate_by_one("datasets/pizza.csv", ["datasets/wheat.csv", "datasets/beef.csv"], model="gaussian")
...
# correlate_by_one("datasets/cake.csv", ["datasets/milk.csv"], model="gaussian")
...
# correlate_by_one("datasets/cake.csv", ["datasets/wheat.csv"], model="gaussian")
...
# correlate_by_one("datasets/cake.csv", ["datasets/milk.csv", "datasets/wheat.csv"], model="gaussian")
...
# correlate_by_one("datasets/cake.csv", ["datasets/pear.csv", "datasets/apple.csv", "datasets/wheat.csv"], model="gaussian")
